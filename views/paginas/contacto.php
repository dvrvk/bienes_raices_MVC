...
<main class="contenedor seccion">
    ...
    <form data-cy="formulario-contacto" class="formulario" action="/contacto" method="POST">
        <fieldset>
            ...
            <textarea data-cy="input-mensaje" type="text" id="mensaje" name="contacto[mensaje]" required></textarea>
        </fieldset>
        ...
        <fieldset>
            ...
            <select data-cy="input-opciones" id="opciones" name="contacto[tipo]" required>
                <option value="" disabled is selected>--Seleccione--</option>
                <option value="Compra">Compra</option>
                <option value="Vende">Vende</option>
            </select>

            <label for="presupuesto">Precio o Presupuesto</label>
            <input data-cy="input-precio" type="number" placeholder="precio/presupuesto" id="presupuesto" name="contacto[precio]" required>
            ...
            <div class="forma-contacto"> <!--name tiene que ser igual para que sean excluyentes-->
